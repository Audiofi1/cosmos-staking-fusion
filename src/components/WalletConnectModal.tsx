          ...
          {!checkKeplrInstalled() && (
            <div className="mb-4 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-md flex items-start gap-2">
              ...
              <div className="text-sm">
                <p className="font-medium text-yellow-500">Keplr extension not detected</p>
                <p className="text-muted-foreground">Please install the Keplr browser extension to connect your Cosmos wallet.</p>
                <a 
                  href="https://www.keplr.app/download" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-crossflip-purple hover:underline mt-1 inline-block"
                >
                  Download Keplr
                </a>
              </div>
            ...
            {walletOptions
              ...
              .map((wallet) => (
                <Button
                  ...
                  disabled={isConnecting || (wallet.id === "keplr" && !checkKeplrInstalled())}
